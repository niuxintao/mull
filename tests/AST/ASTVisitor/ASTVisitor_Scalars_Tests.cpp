...
static mull::TraverseMask traverseMask({MutatorKind::ScalarValueMutator});
...
int add() {
  ...
  ASSERT_TRUE(astMutations.locationExists(
      fakeSourceFilePath, MutatorKind::ScalarValueMutator, 3, 3));
}
...
int add(int a) {
  ...
  const ASTMutation &mutation = astMutations.getMutation(
      fakeSourceFilePath, MutatorKind::ScalarValueMutator, 3, 12);
...
void caller() {
  ...
  const ASTMutation &mutation = astMutations.getMutation(
      fakeSourceFilePath, MutatorKind::ScalarValueMutator, 6, 3);
...
static int func() {
  ...
  ASSERT_TRUE(astMutations.locationExists(
      fakeSourceFilePath, MutatorKind::ScalarValueMutator, 7, 16));
...
static bool func(String &line) {
  ...
  ASSERT_TRUE(astMutations.locationExists(
      fakeSourceFilePath, MutatorKind::ScalarValueMutator, 9, 12));
...
public:
  ...
  const ASTMutation &mutation = astMutations.getMutation(
      fakeSourceFilePath, MutatorKind::ScalarValueMutator, 5, 10);
...
void foo() {
  ...
  const ASTMutation &mutation = astMutations.getMutation(
      fakeSourceFilePath, MutatorKind::ScalarValueMutator, 3, 7);
...
X create_X() {
  ...
  const ASTMutation &mutation = astMutations.getMutation(
      fakeSourceFilePath, MutatorKind::ScalarValueMutator, 8, 10);
...
Enum foo() {
  ...
  const ASTMutation &mutation = astMutations.getMutation(
      fakeSourceFilePath, MutatorKind::ScalarValueMutator, 5, 3);
